...
const translations: Record<Locale, TranslationTree> = {
  es: {
    ...
    teamImport: {
      ...
      rosterSummary: '{{total}} detectados · {{recognized}} reconocidos · {{new}} nuevos · {{ambiguous}} ambiguos',
  ...
  en: {
    ...
    teamImport: {
      ...
      rosterSummary: '{{total}} detected · {{recognized}} recognized · {{new}} new · {{ambiguous}} ambiguous',
