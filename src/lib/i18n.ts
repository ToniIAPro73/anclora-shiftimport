  ...
  es: {
    ...
    landing: {
      ...
      bento: {
        ...
        pdfTitle: 'Importación de PDF',
        pdfBody: 'Sube el cuadrante tal y como lo recibes hoy.',
        csvTitle: 'Importación de CSV',
        csvBody: 'También acepta hojas de cálculo exportadas.',
        detectionTitle: 'Detección de empleados',
        detectionBody: 'Reconoce cada fila y cada turno automáticamente.',
        reviewTitle: 'Revisión antes de importar',
        reviewBody: 'Comprueba los turnos detectados antes de guardarlos.',
        calendarTitle: 'Calendario estructurado',
        calendarBody: 'Turnos listos para consultar, editar y compartir.',
        teamTitle: 'Selección multi-empleado',
        teamBody: 'Elige uno, varios o todos los empleados al importar.',
      },
      team: {
  ...
  en: {
    ...
    landing: {
      ...
      bento: {
        ...
        pdfTitle: 'PDF import',
        pdfBody: 'Upload the roster exactly as you receive it today.',
        csvTitle: 'CSV import',
        csvBody: 'Also accepts exported spreadsheets.',
        detectionTitle: 'Employee detection',
        detectionBody: 'Recognizes every row and every shift automatically.',
        reviewTitle: 'Review before importing',
        reviewBody: 'Check the detected shifts before saving them.',
        calendarTitle: 'Structured calendar',
        calendarBody: 'Shifts ready to view, edit and share.',
        teamTitle: 'Multi-employee selection',
        teamBody: 'Choose one, several, or all employees when importing.',
      },
      team: {
