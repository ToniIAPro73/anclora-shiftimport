...
const translations: Record<Locale, TranslationTree> = {
  es: {
    ...
    settings: {
      ...
      accountSectionDesc: 'Cambios aquí afectan a tu inicio de sesión en todas las organizaciones.',
      accountDisplayName: 'Nombre de la cuenta',
      accountDisplayNamePlaceholder: 'Tu nombre completo',
      accountDisplayNameHint: 'Este nombre se usa como respaldo cuando no hay empleado vinculado.',
      saveAccount: 'Guardar nombre de cuenta',
      localProfileTitle: 'Perfil local (dispositivo)',
      localProfileDesc: 'Solo afecta a la importación de documentos en este navegador.',
      localDisplayNameHint: 'Nombre usado para pre-seleccionar tu fila al importar.',
      employeeSectionTitle: 'Mi empleado',
      employeeSectionDesc: 'Tu perfil de empleado en esta organización. Los cambios se ven en el calendario y cabecera.',
      employeeName: 'Nombre del empleado',
      employeeNamePlaceholder: 'Tu nombre en la empresa',
      employeeExternalId: 'ID externo',
      employeeStatus: 'Estado',
      employeeLinked: 'Vinculado a tu cuenta',
      saveEmployee: 'Guardar nombre de empleado',
      noEmployeeLinked: 'No tienes un perfil de empleado vinculado en esta organización.',
      ...
      personalOrgTitle: 'Organización personal',
      personalOrgDesc: 'Tu espacio personal. Solo tú ves y gestionas tus turnos.',
      companyOrgTitle: 'Organización de empresa',
      companyOrgDesc: 'Espacio compartido para gestionar turnos del equipo.',
    },
    privacy: {
  ...
  en: {
    ...
    settings: {
      ...
      accountSectionDesc: 'Changes here affect your login across all organizations.',
      accountDisplayName: 'Account name',
      accountDisplayNamePlaceholder: 'Your full name',
      accountDisplayNameHint: 'This name is used as fallback when no employee is linked.',
      saveAccount: 'Save account name',
      localProfileTitle: 'Local profile (device)',
      localProfileDesc: 'Only affects document import in this browser.',
      localDisplayNameHint: 'Name used to pre-select your row when importing.',
      employeeSectionTitle: 'My employee',
      employeeSectionDesc: 'Your employee profile in this organization. Changes appear in calendar and header.',
      employeeName: 'Employee name',
      employeeNamePlaceholder: 'Your name in the company',
      employeeExternalId: 'External ID',
      employeeStatus: 'Status',
      employeeLinked: 'Linked to your account',
      saveEmployee: 'Save employee name',
      noEmployeeLinked: 'You do not have an employee profile linked in this organization.',
      ...
      personalOrgTitle: 'Personal organization',
      personalOrgDesc: 'Your personal space. Only you see and manage your shifts.',
      companyOrgTitle: 'Company organization',
      companyOrgDesc: 'Shared space to manage team shifts.',
    },
    privacy: {
