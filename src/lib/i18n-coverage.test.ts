...
const T_KEYS = [
  ...
  'employeePortal.week', 'employeePortal.requests', 'employeePortal.more', 'employeePortal.moreTitle',
  'employeePortal.profile', 'employeePortal.preferences', 'employeePortal.unreadNotifications',
  'employeePortal.unreadNotificationsOne', 'employeePortal.logout',
  ...
  'employeeComments.eyebrow', 'employeeComments.title', 'employeeComments.count',
  'employeeComments.listLabel', 'employeeComments.loading', 'employeeComments.error',
  'employeeComments.retry', 'employeeComments.empty', 'employeeComments.label',
  'employeeComments.placeholder', 'employeeComments.characterCount', 'employeeComments.submit',
  'employeeComments.submitting', 'employeeComments.sent', 'employeeComments.emptyValidation',
  'employeeComments.tooLong', 'employeeComments.sendError',
  'employeeChangeRequest.eyebrow', 'employeeChangeRequest.title', 'employeeChangeRequest.description',
  'employeeChangeRequest.typeLabel', 'employeeChangeRequest.timeChange', 'employeeChangeRequest.other',
  'employeeChangeRequest.reasonLabel', 'employeeChangeRequest.placeholder',
  'employeeChangeRequest.characterCount', 'employeeChangeRequest.submit',
  'employeeChangeRequest.submitting', 'employeeChangeRequest.sent', 'employeeChangeRequest.pending',
  'employeeChangeRequest.cancel', 'employeeChangeRequest.cancelling', 'employeeChangeRequest.cancelled',
  'employeeChangeRequest.cancelledStatus', 'employeeChangeRequest.emptyValidation',
  'employeeChangeRequest.tooLong', 'employeeChangeRequest.sendError', 'employeeChangeRequest.cancelError',
  'employeeRequestStatus.eyebrow', 'employeeRequestStatus.title', 'employeeRequestStatus.description',
  'employeeRequestStatus.filterLabel', 'employeeRequestStatus.all', 'employeeRequestStatus.pending',
  'employeeRequestStatus.approved', 'employeeRequestStatus.rejected', 'employeeRequestStatus.cancelled',
  ...
  'employeeNotifications.retry', 'employeeNotifications.emptyTitle', 'employeeNotifications.emptyDescription',
  'employeeNotifications.shiftPublished', 'employeeNotifications.changeRequestResolved',
