...
| R5-M11 | R5 Final Gate | DONE — PASS; regresión agregada, migración fresh en schema efímero y compatibilidad dev verificadas | R5-M00..M10 | 1 | G0-G15 (subset per spec) |
